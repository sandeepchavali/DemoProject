package com.GoogleplusloginDemo.customui;
 ...
 */
public class Custom_CircularProgressView extends View {
    ...
    public Custom_CircularProgressView(Context context) {
        super(context);
        init(null, 0);
    }

    public Custom_CircularProgressView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public Custom_CircularProgressView(Context context, AttributeSet attrs, int defStyle) {
